...
fn main() -> anyhow::Result<()> {
    ...
    let closest_hit_mirror = ShaderEntryPoint::new("closest_hit_mirror")?;
    let any_hit_alpha_clip = ShaderEntryPoint::new("any_hit_alpha_clip")?;
    ...
    let shader_stages = [
        ...
        *load_rust_shader_module_as_stage(
        ...
        load_shader_module_as_stage(
            &std::fs::read("shaders/closest_hit_textured_glsl.spv")?,

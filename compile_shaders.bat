...
:: rustup +nightly-2021-10-26-pc-windows-msvc component add rust-src rustc-dev llvm-tools-preview
cargo +nightly-2021-10-26-x86_64-pc-windows-msvc run -p compile-shaders --release
